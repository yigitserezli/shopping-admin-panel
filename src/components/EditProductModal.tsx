...
// Zod şeması: Form verilerinin doğrulanması için
...
interface EditProductProps {
    onClose: () => void;
    editProduct: (productId: number, updatedProduct: ProductFormData) => Promise<void>;
    product: Product;
}

const EditProductComponent: React.FC<EditProductProps> = ({ onClose, editProduct, product }) => {
    const {
        register,
        handleSubmit,
        formState: { errors },
